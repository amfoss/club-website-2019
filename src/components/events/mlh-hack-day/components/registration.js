...
class Registration extends React.Component {
    ...
    if (
      ...
      if (Object.prototype.hasOwnProperty.call(response, 'errors')) {
        ...
        this.setState({
          ...
          errorText: '',
          status: response.data.submitApplication.status,
        });
      }
    }
  };
  ...
  getRegisteredCount = async () => {
    ...
    this.setState({
      ...
      slotsLeft: 60 - response.data.registrationForm.applicationsCount,
    });
  };
            ...
            {!this.state.loading ? (
              ...
              this.state.status === 'U' ? (
                <div className="alert alert-success">
                  ...
                  We will get back to soon, meanwhile dont forget to bring your
                  friends as well!
                </div>
              ) : (
                <div className="alert alert-warning">
                  <h5>Thank You! Your application has been Wait listed.</h5>
                  Sorry, we might not be able to accommodate everyone this time, stay
