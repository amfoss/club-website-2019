...
class Registration extends React.Component {
  ...
  register = async () => {
    ...
    if (
      ...
      if (Object.prototype.hasOwnProperty.call(response, "errors")) {
        ...
        this.setState({
          successText: response.data.submitApplication.id,
          errorText: "",
        })
      }
    }
  ...
  getRegisteredCount = async () => {
    ...
    this.setState({
      count: response.data.registrationForm.applicationsCount,
      slotsLeft: 250 - response.data.registrationForm.applicationsCount,
    })
  }
            ...
            {!this.state.loading ? (
              <div>
                <h2 className="my-4 text-light">
                  <span>{this.state.count}</span> Already Registered.
                  <br />
                  {this.state.count < 250 ? (
                    <>
                      <span>
                        {this.state.slotsLeft >= 0 ? this.state.slotsLeft : 0}
                      </span>{" "}
                      Slots Left.
                      <br />
                    </>
                ...
                <p className="text-light">
                  ...
                  and make sure you do that fast as we have limited seats to fit
                  you all in! Also, don't forget to bring in your friends as
                  well :)
                </p>
                <p style={{ color: "red" }}>
                ...
                >
                  <div className="row">
                    ...
                    <div className="col-12 form-check">
                      <div className="m-2 text-light text-center d-flex justify-content-center">
                        ...
                        >
                          ...
                          <a href="#">Privacy Policy</a> of the organizers.
                        </label>
                      </div>
                    </div>
                    ...
                    <div className="col-12 p-0 text-center text-md-right">
                      <div className="m-2">
                        <button type="submit" className="button btn-block px-4">
                          REGISTER
                        </button>
                      </div>
                    </div>
              ...
              <div className="alert alert-success">
                Thank You! You have successfully signed up for the event. We
                will get back to soon, meanwhile dont forget to bring your
                friends as well!
              </div>
            ) : (
