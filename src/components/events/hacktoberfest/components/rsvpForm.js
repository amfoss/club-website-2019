    ...
    return (
      ...
      >
        <div className="p-4">
          ...
          <p>
            Thank you so much for showing interest in Hacktoberfest Meetup, organized
            by amFOSS, in association with Digital Ocean and Dev.to.
          </p>
          <div className="alert alert-warning">
            If you are facing any technical issues, or if your friend didn't recieve
            a confirmation email yet, please ping +91 8139056887 on
