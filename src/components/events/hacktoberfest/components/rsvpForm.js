...
class RSVPForm extends React.Component {
  ...
  render() {
    return (
      ...
      >
        <div className="p-4">
          <h1>RSVP for HacktoberFest Meetup 2019, Amritapuri</h1>
          <p>
            Thank you so much for showing interest in Hacktoberfest Meetup,
            organized by amFOSS, in association with Digital Ocean and Dev.to.
          </p>
          <div className="alert alert-warning">
            If you are facing any technical issues, or if your friend didn't
            recieve a confirmation email yet, please ping +91 8139056887 on
